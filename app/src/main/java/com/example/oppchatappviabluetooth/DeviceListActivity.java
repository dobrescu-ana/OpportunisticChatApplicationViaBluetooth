package com.example.oppchatappviabluetooth;
...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private ListView pairedDevicesList, availableDevicesList;
    ...
    private void init() {
        ...
        progressBarScanDevices = findViewById(R.id.progressbar_scan_devices);
        ...
        pairedDevicesList.setAdapter(adapterPairedDevices);
